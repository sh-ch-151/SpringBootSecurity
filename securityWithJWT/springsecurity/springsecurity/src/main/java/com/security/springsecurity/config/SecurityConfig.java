...
//		return http.build();
		...
		return http
			...
			.requestMatchers("register", "login")//Request matcher is used for no authentication if we set NO aauth in post man then it uses request mmatcher with permitAll()
